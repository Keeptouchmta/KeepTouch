...
import com.keeptouch.Utils.ResizeAnimation;
...
public class EventActivity extends MasterActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(thisActivity, AddEditEventActivity.class);
