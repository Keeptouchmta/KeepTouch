    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        buttonDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent =  new Intent(KeepTouchFriendPickerActivity.this,AddEditEventScreen.class);
        ...
        m_FriendPickerAdapter = new FriendPickerAdapter(this, R.layout.listitem, m_KeepTouchFriend);
